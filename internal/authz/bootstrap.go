	...
	return []RoleSeed{
		...
		},
		{
			...
			Policies: []Policy{
				...
				{Object: "/admin/wallet/manual-recharges", Action: "GET"},
		...
		},
		{
			...
			Policies: []Policy{
				...
				{Object: "/admin/manual-recharge-channels", Action: "*"},
				{Object: "/admin/manual-recharge-channels/:id", Action: "*"},
				{Object: "/admin/orders", Action: "GET"},
				{Object: "/admin/orders/:id", Action: "GET"},
				...
				{Object: "/admin/wallet/recharges", Action: "GET"},
				{Object: "/admin/wallet/manual-recharges", Action: "GET"},
				{Object: "/admin/wallet/manual-recharges/:id/approve", Action: "POST"},
				{Object: "/admin/wallet/manual-recharges/:id/reject", Action: "POST"},
				{Object: "/admin/users/:id/wallet", Action: "GET"},
				{Object: "/admin/users/:id/wallet/transactions", Action: "GET"},
